  ...
  return (
    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="max-w-5xl mx-auto py-16 px-4">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5 hover:scale-110 ease-in duration-300 shadow">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* <div className="flex items-center p-5 hover:scale-110 ease-in duration-300 rounded-lg hover:bg-gray-50 transition-colors duration-300 ease-in-out">
            ...
            {/* <div className="flex items-center p-5 hover:scale-110 ease-in duration-300 rounded-lg hover:bg-gray-50 transition-colors duration-300 ease-in-out">
              ...
              <div className="flex items-center p-5 hover:scale-110 ease-in duration-300 bg-gray-300 rounded-lg hover:bg-gray-400 ">
            ...
            <div className="flex items-center p-5 hover:scale-110 ease-in duration-300  bg-gray-300 rounded-lg hover:bg-gray-400 transition-colors duration-300 ease-in-out">
